        ...
        try 
        {
            if (exchange.getRequestMethod().toLowerCase().equals("post"))
            {
                ...
                if (myLoadResult.getSuccess())
                {
                    ...
                    String jsonStr = "{\"message\" :\"Successfully added " + myLoadResult.getNumUsers() + " users, " + myLoadResult.getNumPersons() + " persons, and " + myLoadResult.getNumEvents() + " events to the database.\"}";
